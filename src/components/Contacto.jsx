...
const Contacto = () => {
  ...
  return (
    <section id="contacto" className="py-20 sm:py-24 lg:py-32 bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1">Servicios Remotos</h4>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <form onSubmit={handleSubmit} className="bg-white p-6 lg:p-8 rounded-xl shadow-md">
